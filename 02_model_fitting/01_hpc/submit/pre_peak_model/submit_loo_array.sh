...
#SBATCH --array=1-4
#SBATCH --output=output/pre_peak_model/loo_%A_%a.out
#SBATCH --error=output/pre_peak_model/loo_%A_%a.err
...
# --- Run script ---
Rscript scripts/pre_peak_model/run_loo_checks.R $SLURM_ARRAY_TASK_ID
