...
formulas <- list(
  bf(SEVERITY_CODE ~ t2(MAX_ANNUAL_DHW, DAYS_FROM_MAX_DHW, k = c(8, 8)) + (1 | spatial_cluster)),
  bf(SEVERITY_CODE ~ t2(MAX_ANNUAL_DHW, DAYS_FROM_MAX_DHW, k = c(8, 8)) + (1 + MAX_ANNUAL_DHW | spatial_cluster)),
  bf(SEVERITY_CODE ~ t2(MAX_ANNUAL_DHW, DAYS_FROM_MAX_DHW, k = c(8, 8)) + (1 | spatial_cluster) + (1 | spatial_cluster:YEAR)),
  bf(SEVERITY_CODE ~ t2(MAX_ANNUAL_DHW, DAYS_FROM_MAX_DHW, k = c(8, 8)) + (1 + MAX_ANNUAL_DHW | spatial_cluster) + (1 | spatial_cluster:YEAR))
)
